...
if(isset($_SESSION['offers_byID'])){
  $offer_set="true";
  $offers_array=json_decode($_SESSION['offers_byID'],true);
...
<div class="container-fluid">
  <div class="card">
    ...
    <input id="offer_set" name="offer_set" type="text" class="form-control" value="<?= $offer_set ?>" hidden/>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="userName" name="userName" type="text" value="<?php echo $offer_set == "true" ? $offers_array['name'] : "" ?>" class="form-control"/>
                  <input type="hidden" name="requestType" value="edit_offer">
                  <input id="offer_ID" name="offer_ID" type="text" class="form-control" value="<?= $offer_id ?>" hidden/>
                </div>
                <div class="form-group">
              ...
              <div class="row">
                <div class="form-group col-lg-12">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="6" ><?php echo $offer_set == "true" ? $offers_array['description'] : "" ?></textarea>
                </div>
              </div>
              <div class="row">
                <div class="form-group col-lg-3">
                  ...
                  type="date"
                  class=" form-control"
                  value="<?php echo $offer_set == "true" ? date($offers_array['validFrom']) : "" ?>"
                  />
                </div>
                <div class="form-group col-lg-3">
                  ...
                  type="date"
                  class=" form-control"
                  value="<?php echo $offer_set == "true" ? date($offers_array['validTo']) : "" ?>"
                  />
                </div>
              </div>
            </section>
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <input id="price_without_tax" name="price_without_tax" type="number"  placeholder="€" value="<?php echo $offer_set == "true" ? $offers_array['price']['value'] : "" ?>" class=" form-control"/>
                    </div>
                    <div class="col-md-6 form-group">
                      <label for="vat">VAT</label>
                      <input id="vat" name="vat" type="number" class="form-control" placeholder="%" value="<?php echo $offer_set == "true" ? $offers_array['price']['vat'] : "" ?>"/>
                    </div>
                  </div>
                <div class="row">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="row">
                    ...
                    <div class="form-group col-lg-12 show_check_res">
                      <label>Cancellation time</label>
                      <input id="web_url" name="web_url" type="text" class="form-control" value="<?php echo $offer_set == "true" ? $offers_array['cancelationTime'] : "" ?>"/>
                    </div>
                  </div>
                </div>
    ...
    <script type="text/javascript">
      $(document).on('click','form a[href*=\\#finish]',function () {
        $('#submitBtn').click();
      })
    </script>
      <script src="<?= BASE_URL ?>/assets/js/app/edit_offer.js"></script>